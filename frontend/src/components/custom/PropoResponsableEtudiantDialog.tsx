...
import type { PropositionEtudiant } from '@/types/validation-proposals/validation-proposals';
...
interface PropoResponsableEtudiantDialogProps {
...
const PropoResponsableEtudiantDialog: React.FC<PropoResponsableEtudiantDialogProps> = ({
  proposition,
  isOpen,
  onClose,
  onActionCompleted
  ...
  const handleAccept = async () => {
    ...
    try {
      await validationPropositionsService.acceptPropositionEtudiant(
        proposition.id,
  ...
  const handleDecline = async () => {
    ...
    try {
      await validationPropositionsService.declinePropositionEtudiant(
        proposition.id,
        proposition.id_group
      );
    ...
    <>
      <Dialog open={isOpen} onOpenChange={onClose}>
        <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            <DialogTitle className="text-center text-2xl font-bold">Proposition de PFE - Etudiant</DialogTitle>
            <DialogDescription className="text-center">
          ...
          <div className="space-y-6 py-4">
            ...
            <div>
              ...
              <textarea
                id="besoins"
                rows={5}
                value={proposition.besoins_materiels || ''}
                className="w-full px-4 py-3 bg-gray-50 border-2 border-gray-200 rounded-lg text-gray-900 font-medium focus:bg-white transition-all duration-200 resize-vertical"
                readOnly
              />
            </div>
...
export default PropoResponsableEtudiantDialog;