...
interface ChangePasswordEnseignantDialogProps {
  children: React.ReactNode;
}

const ChangePasswordEnseignantDialog: React.FC<ChangePasswordEnseignantDialogProps> = ({ children }) => {
    ...
    <Dialog open={open} onOpenChange={handleOpenChange}>
      ...
      <DialogContent className="sm:max-w-[425px]">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          <div>
            <Label htmlFor="dialog-oldPassword" className="block text-sm font-semibold text-gray-700 mb-2">
              Mot de Passe Actuel
            </Label>
            <div className="relative">
              <Input
                type={showOldPassword ? "text" : "password"}
                id="dialog-oldPassword"
          ...
          <div>
            <Label htmlFor="dialog-newPassword" className="block text-sm font-semibold text-gray-700 mb-2">
          ...
          <div>
            <Label htmlFor="dialog-confirmNewPassword" className="block text-sm font-semibold text-gray-700 mb-2">
              Confirmer le Nouveau Mot de Passe
            </Label>
            <div className="relative">
              <Input
                type={showConfirmPassword ? "text" : "password"}
                id="dialog-confirmNewPassword"
...
export default ChangePasswordEnseignantDialog;