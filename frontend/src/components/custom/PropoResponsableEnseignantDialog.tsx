...
import type { PropositionEnseignant } from '@/types/validation-proposals/validation-proposals';
...
interface PropoResponsableEnseignantDialogProps {
    proposition: PropositionEnseignant;
    isOpen: boolean;
    onClose: () => void;
    onActionCompleted: () => void;
}

const PropoResponsableEnseignantDialog: React.FC<PropoResponsableEnseignantDialogProps> = ({
    proposition,
    isOpen,
    onClose,
    onActionCompleted
    ...
    const handleAccept = async () => {
        ...
        try {
            await validationPropositionsService.acceptPropositionEnseignant(
                proposition.id,
                proposition.encadrant_id,
                proposition.co_encadrant_id
            );
    ...
    const handleDecline = async () => {
        ...
        try {
            await validationPropositionsService.declinePropositionEnseignant(
                proposition.id,
                proposition.encadrant_id,
                proposition.co_encadrant_id
            );
                    ...
                    <div className="space-y-6 py-4">
                        ...
                        <div>
                            ...
                            <textarea
                                id="technologies"
                                rows={5}
                                value={proposition.technologies_utilisees || ''}
                                className="w-full px-4 py-3 bg-gray-50 border-2 border-gray-200 rounded-lg text-gray-900 font-medium focus:bg-white transition-all duration-200 resize-vertical"
                                readOnly
                            />
                        </div>
                        ...
                        <div>
                            ...
                            <textarea
                                id="besoins"
                                rows={5}
                                value={proposition.besoins_materiels || 'Aucun'}
                                className="w-full px-4 py-3 bg-gray-50 border-2 border-gray-200 rounded-lg text-gray-900 font-medium focus:bg-white transition-all duration-200 resize-vertical"
                                readOnly
                            />
                        </div>
...
export default PropoResponsableEnseignantDialog;