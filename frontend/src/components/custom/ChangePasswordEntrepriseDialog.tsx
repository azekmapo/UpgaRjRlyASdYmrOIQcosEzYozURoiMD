...
interface ChangePasswordEntrepriseDialogProps {
  children: React.ReactNode;
}

const ChangePasswordEntrepriseDialog: React.FC<ChangePasswordEntrepriseDialogProps> = ({ children }) => {
...
export default ChangePasswordEntrepriseDialog;