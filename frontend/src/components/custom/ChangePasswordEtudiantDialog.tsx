...
interface ChangePasswordEtudiantDialogProps {
  children: React.ReactNode;
}

const ChangePasswordEtudiantDialog: React.FC<ChangePasswordEtudiantDialogProps> = ({ children }) => {
...
export default ChangePasswordEtudiantDialog;